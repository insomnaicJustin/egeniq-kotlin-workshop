...
/**
 * Created by ruben on 27/06/2017.
 */
class CreateEditFragment : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            val position = arguments.getInt(DetailsFragment.ARG_POSITION)
            ...
            val revealX = arguments.getFloat(DetailsFragment.ARG_REVEAL_X)
            val revealY = arguments.getFloat(DetailsFragment.ARG_REVEAL_Y)
